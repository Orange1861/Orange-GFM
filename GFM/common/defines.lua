...
country = {
	...
	WRONG_REFORM_RADICAL_IMPACT = 16,
	TECH_YEAR_SPAN = 150,
...
military = {
	...
	AI_NAVY_TAXBASE_FRACTION = 0.4, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs) Abe edit: used to be 0.2
...
pops = {
	...
	REBEL_OCCUPATION_STRENGTH_BONUS = 0.02, -- the2 amount of strength given to rebel movements when they occupy a province
